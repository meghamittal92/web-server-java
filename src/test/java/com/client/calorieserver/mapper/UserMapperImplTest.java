...
public class UserMapperImplTest {
	...
	void toUserView() {
		...
		User user = generateUser(TestData.default_username, TestData.default_password, TestData.default_email, 12L);
	...
	@Test
	void toUserListView() {
		User user1 = generateUser("test_user1", "test_pass1", "test1@gmail.com", 12L);
		User user2 = generateUser("test_user2", "test_pass2", "test2@gmail.com", 13L);
	...
	@Test
	void toUserDTO() {
		User user = generateUser(TestData.default_username, TestData.default_password, TestData.default_email, 1L);
	...
	void rolesToRoleDTOs() {
		...
		for (RoleDTO roleDTO : roleDTOS) {
			assert (roleDTO.getName().equalsIgnoreCase("USER") || roleDTO.getName().equalsIgnoreCase("ADMIN"));
		}
