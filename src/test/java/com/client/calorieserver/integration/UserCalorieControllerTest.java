...
public class UserCalorieControllerTest extends BaseIntegrationTest{
    ...
    void create() throws Exception{
        ...
        MvcResult result = mockMvc.perform(post(userCaloriesRequestPath)
    ...
    void findById() throws Exception{
        ...
        result = mockMvc.perform(get(userCaloriesRequestPath + "/" +id)
                .contentType(MediaType.APPLICATION_JSON)
                .header(HttpHeaders.AUTHORIZATION, token))
                .andExpect(status().is2xxSuccessful())
                .andReturn();
    ...
    void deleteById() throws Exception{
        ...
        result = mockMvc.perform(post(userCaloriesRequestPath)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(params))
                .header(HttpHeaders.AUTHORIZATION, tokenNew))
                .andExpect(status().is2xxSuccessful())
                .andReturn();
        ...
        result = mockMvc.perform(delete(userCaloriesRequestPath + "/" +otherId)
                .contentType(MediaType.APPLICATION_JSON)
                .header(HttpHeaders.AUTHORIZATION, token))
                .andExpect(status().is4xxClientError())
                .andReturn();

        result = mockMvc.perform(delete(userCaloriesRequestPath + "/" +id)
                .contentType(MediaType.APPLICATION_JSON)
                .header(HttpHeaders.AUTHORIZATION, token))
                .andExpect(status().is2xxSuccessful())
                .andReturn();
    ...
    void UpdateCalorie() throws Exception{
        ...
        result = mockMvc.perform(patch(userCaloriesRequestPath + "/" +id)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(params))
                .header(HttpHeaders.AUTHORIZATION, token))
                .andExpect(status().is2xxSuccessful())
        ...
        result = mockMvc.perform(get(userCaloriesRequestPath + "/" +newId)
                .contentType(MediaType.APPLICATION_JSON)
                .header(HttpHeaders.AUTHORIZATION, token))
                .andExpect(status().is2xxSuccessful())
                .andReturn();
    ...
    void ReplaceCalorie() throws Exception{
        ...
        result = mockMvc.perform(put(userCaloriesRequestPath + "/" +id)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(params))
                .header(HttpHeaders.AUTHORIZATION, token))
                .andExpect(status().is2xxSuccessful())
    ...
    void findAll() throws Exception{
        ...
        String token = registerUser("user1", "password1$", 10L);
        Map<String, String> params = generateCalorieRequest(1, LocalDateTime.now(), "detail_1");
         mockMvc.perform(post(userCaloriesRequestPath)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(params))
                .header(HttpHeaders.AUTHORIZATION, token))
                .andExpect(status().is2xxSuccessful())
        ...
        MvcResult result = mockMvc.perform(get(userCaloriesRequestPath)
                .contentType(MediaType.APPLICATION_JSON)
                .header(HttpHeaders.AUTHORIZATION, token))
                .andExpect(status().is2xxSuccessful())
                .andReturn();
        ...
        result = mockMvc.perform(get(userCaloriesRequestPath)
                .contentType(MediaType.APPLICATION_JSON)
