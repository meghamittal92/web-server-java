...
public class UserDTOSpecificationIntegrationTest {
	...
	private static Stream<Arguments> providerQuerySuccess() {
		return Stream.of(
				...
				Arguments.of(
						new Filter(UserSearchKey.expectedCaloriesPerDay.getName(), RelationalOperator.GREATER_THAN, 50),
						1),
				Arguments.of(new Filter(UserSearchKey.expectedCaloriesPerDay.getName(),
						RelationalOperator.GREATER_THAN_EQUAL_TO, 50), 2),
				Arguments.of(
						new Filter(UserSearchKey.expectedCaloriesPerDay.getName(), RelationalOperator.LESS_THAN, 50),
						0),
				Arguments.of(new Filter(UserSearchKey.expectedCaloriesPerDay.getName(),
						RelationalOperator.LESS_THAN_EQUAL_TO, 50), 1),
				Arguments.of(new Filter(UserSearchKey.expectedCaloriesPerDay.getName(), RelationalOperator.EQUAL, 100),
						1),
				Arguments.of(
						new Filter(UserSearchKey.expectedCaloriesPerDay.getName(), RelationalOperator.NOT_EQUAL, 500),
						2));
	}
